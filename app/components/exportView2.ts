...
<html>
  ...
  <body class="justify-center align-center text-center selection:opactiy-[50%] p-1 bg-[url(https://raw.githubusercontent.com/hpware/esp32-postgres-logger-view-and-api/refs/heads/main/bg.jpg?raw=true)] bg-cover bg-no-repeat bg-center">
  ...
  <script>
    ...
    const socket = new WebSocket("wss://pgiot.sch2.top/logger/");
